(function () {
  ...
  const load = (name) =>
    fetch(`https://cats.nmsc.pchapl.dev/${name}`).then((res) => res.text());
  ...
  const drawA = (data) =>
    (document.getElementsByClassName("container-a")[0].innerHTML = data);
  const drawB = (data) =>
    (document.getElementsByClassName("container-b")[0].innerHTML = data);
  const drawC = (data) =>
    (document.getElementsByClassName("container-c")[0].innerHTML = data);
  const drawD = (data) =>
    (document.getElementsByClassName("container-d")[0].innerHTML = data);
  ...
  document
    .getElementsByClassName("btn-reset")[0]
